...
class TestFilters(object):
    ...
    @staticmethod
    def test_filters_all(message):
        assert Filters.all(message)

    @staticmethod
    def test_filters_text(message):
        message.text = 'test'
    ...
    @staticmethod
    def test_filters_command(message):
        message.text = 'test'
    ...
    @staticmethod
    def test_filters_regex(message):
    ...
    @staticmethod
    def test_filters_reply(message):
    ...
    @staticmethod
    def test_caption_entities_filter(message, message_entity):
    ...
    @staticmethod
    def test_filters_user_id(message):
    ...
    @staticmethod
    def test_filters_username(message):
    ...
    @staticmethod
    def test_language_filter_multiple(message):
    ...
    @staticmethod
    def test_and_or_filters(message):
        message.text = 'test'
        message.forward_date = True
    ...
    @staticmethod
    def test_inverted_filters(message):
        message.text = '/test'
        assert Filters.command(message)
        assert not (~Filters.command)(message)
        message.text = 'test'
    ...
    @staticmethod
    def test_inverted_and_filters(message):
        message.text = '/test'
    ...
    @staticmethod
    def test_faulty_custom_filter(message):
    ...
    @staticmethod
    def test_custom_unnamed_filter(message):
